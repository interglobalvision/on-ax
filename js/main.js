...
function getZDepths() {
  ...
  for (var i = 0; i < canvasWidth + 1; i++) {
    for (var j = 0; j < canvasHeight + 1; j++) {
      ...
      var gotoZ = params.zDepth * brightness - params.zDepth / 1.3;
...
var arpPlayer = {
  ...
  init: function() {
    ...
    var trackUrl = "https://soundcloud.com/a-rp/dreadful-birds-fat-paranoia";//document.getElementById(urlInputId).value;
    ...
    SC.get('/resolve', {
      url:'https://soundcloud.com/a-rp/dreadful-birds-fat-paranoia',
    }, function(track) {
